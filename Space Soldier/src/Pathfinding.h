...
public:
    ...
    int blockedGid = 309; //Gid of the tiles that block the path - Important adjust this value to your map
    int highCostGid = 310; //Gid of the tiles that have high cost - Important adjust this value to your map
